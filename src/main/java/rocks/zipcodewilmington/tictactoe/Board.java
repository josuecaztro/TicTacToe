...
//
//
//        //called readrow1 method (iff row1 === xxx return "X"
//        //call Diagnol1 (if diagnol === OOO) return "O"

//        if (whoWins.)
//        //if XXX = X is winner
//        //if else OOO = O is winner
//        //else if neither = "tie"
//
//        String str = "";
//        for (int i = 0; i < 3; i++){
...
//        solutionList.add(str);
            ...
            //row1 = str "OXo" -> arraylist
            //row = str "XXo" -> arraylist
        //diagnol2 = str "XXX" -> arrayList

        //arraylist {"oxo", "xxo" , "xxx");

        //if arraylist.contains"xxx" x wins
